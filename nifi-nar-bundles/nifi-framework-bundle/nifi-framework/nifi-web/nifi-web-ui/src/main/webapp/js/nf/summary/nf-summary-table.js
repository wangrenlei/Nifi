...
nf.SummaryTable = (function () {
    ...
    var initSummaryTable = function (isClustered) {
        ...
        var clusterProcessorsColumnModel = [
            {id: 'node', field: 'node', name: nf._.msg('Node'), sortable: true, resizable: true},
            runStatusColumn,
            inputColumn,
            ioColumn,
            outputColumn,
        ...
        $('#cluster-connection-summary-dialog').modal({
            ...
            buttons: [{
                buttonText: nf._.msg('nf-summary-table.ClusterConnectionSummary'),
                color: {
                    base: '#728E9B',
                    hover: '#004849',
                    text: '#ffffff'
    ...
    var addStorageUsage = function (container, storageUsage) {
        ...
        (nf.ng.Bridge.injector.get('$compile')($('<md-progress-linear class="md-hue-2" md-mode="determinate" value="' + (used/total)*100 + '" aria-label="'+nf._.msg('nf-summary-table.aria1')+'"></md-progress-linear>'))(nf.ng.Bridge.rootScope)).appendTo(storageUsageContainer);
