        ...
        <div id="event-details-tabs-content">
            ...
            <div id="content-tab-content" class="details-tab">
                ...
                <div id="replay-details" class="content-details hidden">
                    ...
                    <div class="event-detail">
                        <div id="replay-content" class="secondary-button fa fa-repeat button-icon"><span><fmt:message key="partials.provenance.provenance-event-details-dialog.Replay"/></div>
                        <div class="clear"></div>
                    </div>
                </div>
            </div>
